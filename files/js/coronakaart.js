...
var layerCorona = config.layer_corona;
...
L.tileLayer.wms(host + ':' + geoserver_port + '/geoserver/' + workspace + '/wms?', {
    layers: workspace + ':' + layerCorona,
    format: 'image/png',
    transparent: true
}).addTo(coronakaart);
...
$.getJSON(
    host + ':' + geoserver_port + '/geoserver/' + workspace + '/ows?service=WFS&version=2.0.0&request=GetFeature&typeName=' + workspace + '%3A' + layerCorona + '&maxFeatures=50&outputFormat=application%2Fjson', 
    function (data) {
